...
<p> Цель - моделирование изменения балансов студентов (кол-ва уроков, которое есть у каждого студента) за 2016 год.</p>
 ...
 __Как решала :__
<p> Исходные данные: в корпоративной БД мы имеем две таблицы: содержащую данные о любых действиях клиентов (как представляющих интерес для бизнеса, так нет) - classes, и об оплатах пакетов уроков - payments.</p>
