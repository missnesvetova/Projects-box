...
1. На основе т.classes были собраны все дни отчетного периода (2016 года), когда студенты были активны (в таблице есть данные о завершенном действии по стлбцу class_end_datetime); на основе т.payments - сформирована таблица с датами первых оплат для каждого студента. 
Далее эти CTE были объединены по неравенству для получения датасета об активностях (уроках) студентов, которые представляют коммерческий интерес для компании (уроки после даты первой оплаты для каждого студента). 
