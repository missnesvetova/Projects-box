...
Цель кейса - отработать полный цикл работы с данными — от извлечения информации через API до построения визуальной аналитики, применимой к бизнес-кейсам (в данном случае — анализ динамики акций Tesla и Rivian).
