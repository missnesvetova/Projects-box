...
> 1. На основе т.classes были собраны все дни отчетного периода (2016 года), когда студенты были активны (в таблице есть данные о завершенном действии, опираясь на столбец с датой окончания активности); на основе т.payments - сформирована таблица с датами первых оплат для каждого студента. 
> Далее эти CTE были объединены по неравенству для получения датасета об активностях студентов, которые представляют коммерческий интерес для компании (активности после оплаты). </p>
